...
// JANELAS CRIADAS NA PARTE CINZA DA INTERFACE GRAFICA PARA UTILIZACAO DAS FUNCIONALIDADES DO PROGRAMA
			...
			switch (wParam){
				...
				/*7*/case ATENDIMENTO_LISTAR_TUDO:{
						...
						if(posAtendimento == 0){														 
							...
							int i;
							char lista[1000], idAluno[10], idSupervisor[10], idPaciente[10], dia[10], mes[10], ano[10], codigoAgendamento[10], codigoAtendimento[10];
				...
				/*14*/case AGENDAMENTO_LISTAR:{
						...
						if(posAgendamento == 0){														 
							...
							int i, j;
							char lista[1000], nomePaciente[100], area[20], dia[3], mes[3], ano[5], codigo[3], id[5];
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR IpCmdLine, int nCmdShow){
	...
	//largura, altura, NULL porque esta janela é a main, nao tem parentes, NULL porque nao tem menu ate o momento, parametro passado no main,
